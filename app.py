...
# -*- coding: utf-8 -*-
"""
Created on Mon Nov 16 12:41:54 2020
...
def model_predict(img_path, model):
   ...
   # x = preprocess_input(x)
    ...
    if preds==0:
        ...
        preds="Te Disease is Tomato__Leaf_mold"
    elif preds==4:
        preds="The Disease is Tomato__Septoria_leaf_spot"
    elif preds==5:
        preds="The Disease is Tomato__Spider_mitesTwo-spotted_spider_mite"
    elif preds==6:
        preds="The Disease is Tomato__Target_spot"
    elif preds==7:
        preds="The Disease is Tomato_Yellow_Leaf_Curl_Virus"
    elif preds==8:
        preds="The Disease is Tomato__Tomato_mosaic_virus"
    else:
        preds="The Disease is Tomato__healthy"
